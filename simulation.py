...
class Simulation(object):
    ...
    def draw(self, window):
        ...
        ex = round(M2PIX * (self.roomba.pose.position.x + self.roomba.radius * math.cos(self.roomba.pose.rotation)))
        ey = round(M2PIX * (self.roomba.pose.position.y + self.roomba.radius * math.sin(self.roomba.pose.rotation)))
